...
| --- | ---: | ---: | ---: |
| 16 MiB | 0.883 s · 18.12 MiB/s | 0.825 s · 19.38 MiB/s | 68.28 MiB |
| 256 MiB | 6.495 s · 39.42 MiB/s | 7.929 s · 32.29 MiB/s | 68.36 MiB |

Both files matched SHA-256 after upload and download. Before transfers, the
process's lifetime peak RSS was 62.50 MiB. After the 256 MiB cases it was
68.36 MiB, a 5.86 MiB increase. That is consistent with bounded-memory copying
...
These are single runs on macOS 26.5.1 arm64, Python 3.12.12, Docker Desktop's
...
take roughly 26–32 seconds per direction, plus variability in disk, network,
