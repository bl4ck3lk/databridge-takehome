...
| --- | ---: | ---: | ---: |
| 16 MiB | 0.557 s · 28.72 MiB/s | 0.503 s · 31.82 MiB/s | 72.98 MiB |
| 256 MiB | 2.132 s · 120.09 MiB/s | 3.726 s · 68.71 MiB/s | 73.41 MiB |
| 16 MiB, 20 ms round trip | 1.011 s · 15.82 MiB/s | 0.823 s · 19.43 MiB/s | 73.41 MiB |

Every file matched SHA-256 after upload and download. Before transfers, the
process's lifetime peak RSS was 63.34 MiB. After the 256 MiB case it was
73.41 MiB, a 10.07 MiB increase, and it stayed there for the later latency
case. This is consistent with bounded-memory copying: 1 MiB chunks plus up to 64 SFTP
...
| --- | ---: | ---: |
| Loopback upload | 17.39 MiB/s | 28.72 MiB/s |
| Loopback download | 19.35 MiB/s | 31.82 MiB/s |
| 20 ms round trip, upload | 1.22 MiB/s (13.15 s) | 15.82 MiB/s (1.01 s) |
| 20 ms round trip, download | 1.26 MiB/s (12.75 s) | 19.43 MiB/s (0.82 s) |
...
The current results are single runs of code commit `39a064e` with the
...
take roughly 9–15 seconds per direction, plus variability in disk, network,
